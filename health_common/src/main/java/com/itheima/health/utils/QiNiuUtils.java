...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "q5Ti3tljsLD1IfSLqGlGcC1RKbTCV8FQF5YibZTd";
    private static final String SECRETKEY = "BdxNpzkvJQ0wT-zTyx0lOcmTIzTTKY6WPLegWAvO";
    private static final String BUCKET = "doerfei1";
    public static final String DOMAIN= "http://qkak91nvg.hn-bkt.clouddn.com/";
